...
CREATE TABLE `admin` (
  ...
  PRIMARY KEY (`AdminID`),
  UNIQUE KEY `uq_admin_userid` (`UserID`),
  CONSTRAINT `fk_admin_user` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserID`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=95330 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `admin` VALUES (7,7860),(95329,93478);
